...
public interface TransistorKeys {
    ...
    /* ACTIONS */
    String ACTION_PLAY = "ru.rpw.radio.action.PLAY";
    String ACTION_STOP = "ru.rpw.radio.action.STOP";
    String ACTION_DISMISS = "ru.rpw.radio.action.DISMISS";
    String ACTION_PLAYBACK_STATE_CHANGED = "ru.rpw.radio.action.PLAYBACK_STATE_CHANGED";
    String ACTION_METADATA_CHANGED = "ru.rpw.radio.action.METADATA_CHANGED";
    String ACTION_SHOW_PLAYER = "ru.rpw.radio.action.SHOW_PLAYER";
    String ACTION_TIMER_RUNNING = "ru.rpw.radio.action.TIMER_RUNNING";
    String ACTION_TIMER_START = "ru.rpw.radio.action.TIMER_START";
    String ACTION_TIMER_STOP = "ru.rpw.radio.action.TIMER_STOP";
